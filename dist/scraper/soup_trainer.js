...
class SoupStrainer {
     ...
     * document.
     */
    constructor(name = null, attrs = {}, str = null, ...kwargs) {
        this.name = this._normalize_search_value(name);
        if (Object.keys(kwargs).length) {
            if (Object.keys(attrs).length) {
                attrs = Object.assign(Object.assign({}, attrs), kwargs);
            }
            else {
                attrs = kwargs;
            }
    ...
    search_tag(markup_name = null, markup_attrs = {}) {
        let found = null;
        let markup = null;
        ...
        const call_function_with_tag_data = (typeof this.name === 'function' && !(markup_name instanceof Tag));
    ...
    _matches(markup, match_against, already_tried = new Set()) {
...
class Tag {
    constructor(name, prefix = null, string = null) {
        this.name = name;
        this.prefix = prefix;
        this.string = string;
    }
